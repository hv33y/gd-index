...
//
self.props = {
    title: 'Google Drive Index', // change it to whatever you want
    default_root_id: 'root', // the default is "root"
    client_id: '202264815644.apps.googleusercontent.com', // highly recommended to use your own client_id.
    client_secret: 'X4Z3ca8xfWDb1Voo-F9a7ZxJ', // highly recommended to use your own client_id.
    refresh_token: '',
    service_account: false, // set it to "true" to use service account.
    service_account_json: sa_array[random],
    auth: false, // set to "true" to enable basic http authentication when visiting the site.
    user: '',
    pass: '',
    upload: false,
