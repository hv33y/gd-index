...
const authConfig = {
   ...
   * To get the most performance, use your own client_id and not the one from rclone.
   *
  ...
  **/
  "roots": [
    /**
      ...
      * To enable password protection, remove "//" in the front of the line "auth:".
    **/
    {
      id: "root",
      name: "Drive 1",
  ...
  // Set this to "true" to allow downloading of files that are flagged as virus by Google.
  "enable_virus_infected_file_down": false,

  // Set this to "true" to sort files by modified time.
  "sort_by_modified_time": false,

  // Set this to "true" to allow downloading of files in the trash
  "include_trashed_files": false, // Files will be visible on the same place as before they were trashed
...
const uiConfig = {
  ...
  "credits": false, // Set this to true if you like to give credits. Otherwise you can set it to false.
