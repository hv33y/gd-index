...
function init() {
    ...
    var pan_bar = `
                    <div class="titleBar_item titleBar_pan">
                        ...
                        <div class="menu_list titleBar_exhibit"><p>Drive</p>`;
...
function onSearchResultItemClick(a_ele) {
    ...
    var dialog = mdui.dialog({
        title: '',
        content: '<div class="mdui-text-center mdui-typo-title mdui-m-b-1">Loading...</div><div class="mdui-spinner mdui-spinner-colorful mdui-center"></div>',
